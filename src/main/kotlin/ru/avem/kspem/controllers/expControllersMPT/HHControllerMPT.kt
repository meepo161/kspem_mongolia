...
//                appendMessageToLog(
//                    LogTag.DEBUG,
//                    "Подъем напряжения обмотки возбуждения и обмотки якоря. Ступень ${(i * 10).autoformat()}%"
//                )
//                voltageRegulation(voltageOVSet * step, 15, 7, 4)
//                voltageRegulationTVN(voltageOYSet * step, 300, 600)
//            }
